#include <iostream>
#include <string>
class ICoffee {//componente
public:
    virtual float GetCost() = 0;
    virtual std::string GetDescription() = 0;
};
class SimpleCoffee : public ICoffee {//componente concreto
public:
    float GetCost() override { return 10; }
    std::string GetDescription() override { return "Simple coffee"; }
};
class CoffeePlus : public ICoffee {//decorador
public:
...
class MilkCoffee : public CoffeePlus {//decorador concreto
public:
